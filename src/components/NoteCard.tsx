...
const NoteCard = ({ note, onClick, onDelete, onEdit }: NoteCardProps) => {
    ...
    return (
        <div className="note-card break-inside-avoid inline-block w-full border-2 border-gray-100 p-4 rounded-lg bg-transparent mb-4" onClick={onClick}>
            <section id="note-card--content" className="flex flex-col gap-2">
                {isEditing ? (
